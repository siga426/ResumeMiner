...
from aiagentplatformpy.chat import Message, MessageContentType, MessageRole
from aiagentplatformpy.model import AsyncLastIDPaged, AiAgentPlatformModel, HTTPRequest, LastIDPaged, LastIDPagedResponse
from aiagentplatformpy.request import Requester
from aiagentplatformpy.util import remove_url_trailing_slash


class _PrivateListMessageResp(AiAgentPlatformModel, LastIDPagedResponse[Message]):
    first_id: str
    last_id: str
    has_more: bool
    items: List[Message]
